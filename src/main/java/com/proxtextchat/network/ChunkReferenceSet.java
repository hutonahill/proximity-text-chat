 ...
 */
public class ChunkReferenceSet implements Set<ChunkReference> {
// We need this class to provide the CODEC

    private final Set<ChunkReference> _chunks;
    ...
    public ChunkReferenceSet(Collection<ChunkReference> chunks){
        _chunks = new HashSet<>(chunks);
    }

    /**
     * Creates and empty ChunkReferenceSet.
     */
    public ChunkReferenceSet(){
        _chunks = new HashSet<>();
    }
    ...
    public boolean contains(Object o) {
        return _chunks.contains(o);
    }

    @Override
    public boolean add(ChunkReference reference){
        return _chunks.add(reference);
    }
     ...
     *                                       specified collection prevents it from being added to this set
     * @see #add(ChunkReference)
     */
    @Override
    public boolean addAll(@NotNull Collection<? extends ChunkReference> c) {
        return _chunks.addAll(c);
    }
